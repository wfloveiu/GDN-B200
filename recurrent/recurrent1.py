...
if __name__ == "__main__":
    ...
    ref = PytorchModel(*get_init_inputs()).cuda()
    opt = TritonModel(*get_init_inputs()).cuda()
    ...
    abs_diff = (ref_f - opt_f).abs()
    rel_diff = abs_diff / (ref_f.abs() + 1e-6)
