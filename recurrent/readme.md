...
```
====================================================================================================
 Batch |   Qwen(Triton) |        CUDA_V1 |        CUDA_V2 |        CUDA_V3 |        CuTeDSL |     V3 vs Qwen
------------------------------------------------------------------------------------------------------------
     1 |          38.02 |           6.12 |           6.15 |           6.09 |          15.01 |    6.2x faster
     4 |          36.29 |           6.13 |           5.75 |           5.39 |          15.14 |    6.7x faster
     8 |          36.10 |           8.20 |           6.16 |           6.09 |          15.13 |    5.9x faster
    16 |          35.92 |          10.25 |           8.20 |           8.20 |          15.70 |    4.4x faster
    32 |          36.42 |          18.44 |          12.31 |          10.58 |          16.43 |    3.4x faster
    64 |          35.52 |          34.83 |          25.54 |          24.65 |          26.66 |    1.4x faster
   128 |          43.12 |          62.92 |          46.06 |          45.06 |          55.37 |    4.3% slower
   256 |          82.01 |         114.80 |          87.75 |          85.75 |         104.54 |    4.4% slower
   512 |         160.66 |         218.69 |         172.43 |         168.90 |         208.30 |    4.9% slower
  1024 |         318.74 |         426.55 |         350.50 |         335.30 |         413.91 |    4.9% slower
------------------------------------------------------------------------------------------------------------
  (us) |   lower=better |   lower=better |   lower=better |   lower=better |   lower=better |               
```
